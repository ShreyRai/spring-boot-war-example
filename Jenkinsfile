pipeline{
    ...
    post{
            ...
            success{
                ...
                Check console output at $BUILD_URL to view the results.''', subject: 'Success | Build: $BUILD_STATUS', to: 'digimark200@gmail.com'
            }
            failure{
                echo "Deployment has been failed, please check the logs for the errors"
                emailext body: '''Hi ,
                This is mail generated by jenkins to show the general status of Project: $PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS:
                Check console output at $BUILD_URL to view the results.''', subject: 'SFailed | Build: $BUILD_STATUS', to: 'digimark200@gmail.com'
            }
    }
}
